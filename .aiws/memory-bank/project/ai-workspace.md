...
- server_dirs:
  - ./apps/cms          # Payload 后台/内容/线索（连 Docker postgres）
- web_dirs:
  - ./apps/astro        # Astro 公开站（SSG，dev 端口 4321）
- app_dirs:
  - ./app
...
- base_url: "http://127.0.0.1:3000"   # Payload dev（cms）
- health_path: "/api/v2/health"       # Phase 1 /api/v2 信封健康端点
